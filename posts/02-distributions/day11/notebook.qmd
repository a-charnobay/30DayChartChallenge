...
p <- (p1 + p2 + p3 + p4) + 
  ...
  plot_annotation(
    ...
    subtitle = paste0(
     "Brazil has more than 5 million farms, yet only a small fraction are mechanized, <span style='color:", col_highlight, ";'><b>tractors</b></span> are the<br>most common asset, but they are still present in only a minority of farms."
    ),
    caption = paste0(
